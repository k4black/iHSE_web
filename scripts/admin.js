...
table = new Vue({
    ...
    data: {
        ...
        filterText: '',
        // data: [{'name':1, 'email':1231, 'birthdate':5234, 'nickname':23423, 'gender':32112},]
    },
    computed:{
        /*httpOptions(){
